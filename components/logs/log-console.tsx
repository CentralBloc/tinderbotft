...
// }
//
// export default function LogConsole({accountId, sessionId}: Readonly<SessionLogsProps>) {
//     const {data: logs, isLoading} = useSessionLogsHooks(accountId, sessionId);
...
//     const sessions = Array.from(new Set(logs.map((log: { session: any }) => log.session).filter(Boolean)))
//
